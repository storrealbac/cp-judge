...
export default function ProblemPage() {
  ...
  const problem_statement: string = `
...
`;
  ...
  const output: string = `For each test case, output the maximum number of words $x$ such that the first $x$ words have a total length of no more than $m$.`
    ...
    <div className="container mx-auto p-6">
      ...
      <div className="grid grid-cols-4 gap-6">
        ...
        <div className="col-span-3">
          ...
          <Testcase input={inputValue} output={outputValue} className="mb-6"/>
